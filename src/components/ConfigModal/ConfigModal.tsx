...
const HighlightRuleEditor: React.FC<{ rule: HighlightRule; onChange: (patch: Partial<HighlightRule>) => void; onDelete: () => void }> = ({ rule, onChange, onDelete }) => (
...
const SendCmdEditor: React.FC<{ cmd: SendCommand; cmdIdx: number; onChange: (patch: Partial<SendCommand>) => void; onDelete: () => void }> = ({ cmd, cmdIdx, onChange, onDelete }) => (
  <div style={{ background: 'var(--bg-secondary)', borderRadius: 4, padding: 8, marginBottom: 6 }}>
