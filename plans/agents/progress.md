...
| 串口管理边栏 (Sidebar) | ✅ 已完成 | 90% |
| 主显示区 (MainDisplay) | ✅ 已完成 | 85% |
| 操作面板 (OperationPanel) | ✅ 已完成 | 90% |
...
**遗留事项**:
- [ ] `splitPane` Action 目前仅创建新 pane，未实现真正的分屏布局计算
- [ ] 缺少拖拽排序相关的 Actions（标签页拖拽、串口列表拖拽）
...
- [x] 标签栏容器
- [x] 分屏与更多操作按钮
- [x] 终端工具栏（状态指示、串口信息、编码选择）
- [x] 空状态提示

**遗留事项**:
- [ ] 分屏逻辑完善（目前仅创建 pane，未实现真正的分屏布局）
- [ ] 新建标签页按钮功能
...
| 分屏功能仅创建 pane 未实现布局 | 功能不完整 | 需要设计分屏布局算法 |
