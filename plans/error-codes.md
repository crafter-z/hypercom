...
| `Storage` | `Storage error: {details}` | `commands/storage.rs:41`, `72`, `87`, `92`, `130`, `135`, `171`, `201`, `216`, `221`, `258`, `263`, `300`, `324`, `339`, `344`, `359`, `364` (CRUD for command sets, highlight sets, protocol templates). Wraps `sqlx` / `StorageManager` errors. | `toast.error.storage` |
